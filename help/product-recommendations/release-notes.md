...
![Korrigera](../assets/fix.svg) Ett fel har korrigerats där användaren omdirigerades till hemsidan i stället för att stanna kvar på den aktuella sidan genom att klicka på knappen **[!DNL Add to Cart]** för en enkel produkt i en Recommendations-produktenhet.
...
![Nytt](../assets/new.svg) Nya feeds har lagts till i [synkronisera katalogdata](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/user-guides/data-services/catalog-sync) till Commerce Services via kommandoraden
...
![Nytt](../assets/new.svg) Stöd har lagts till för Adobe Client Data Layer för att standardisera beteendedatainsamling för alla funktioner och tjänster i Adobe Commerce. Mer information finns i [Viktigt](https://github.com/adobe/commerce-events/blob/main/packages/storefront-events-collector/README.md).
...
![Nytt](../assets/new.svg) har bytt namn på Magento Services till [Commerce Services](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/user-guides/integration-services/saas) och har förbättrats användbarheten i Admin
...
![Nytt](../assets/new.svg) har lagt till möjligheten att [övervaka och hantera](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/user-guides/data-services/catalog-sync) katalogsynkroniseringsprocessen från administratören.
...
![Nytt](../assets/new.svg) har lagt till möjligheten att [synkronisera om](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/user-guides/data-services/catalog-sync) din katalog till SaaS-tjänster via kommandoraden.
...
* [Utvecklardokumentation](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/product-recommendations/developer/development-overview)
