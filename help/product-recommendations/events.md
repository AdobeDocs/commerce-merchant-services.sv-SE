...
>[!NOTE]
>
>Produktrekommendationsstatistik är optimerad för Luma storefront. Om din storefront implementeras med PWA Studio finns mer information i [dokumentationen för PWA](https://developer.adobe.com/commerce/pwa-studio/integrations/product-recommendations/). Om du använder en anpassad klientteknik som React eller Vue JS, ska du lära dig hur du integrerar [Product Recommendations i en headless](headless.md)-miljö.
...
- [Headless-implementeringar](headless.md) måste implementera händelser för att produktkontrollpanelen för Recommendations ska fungera.
