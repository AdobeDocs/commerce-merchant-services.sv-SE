...
1. På menyn klickar du på **Redigera**. Justera sedan följande egenskaper efter behov.
   ...
   * Maxvärde - Ange det maximala antalet fasettvärden som visas i butiken. Giltiga poster: 0-10
...
| Maxvärde | Det maximala antalet värden som kan visas i butiken för varje aspekt. Ansikten som representerar ett värdeintervall fördelas jämnt. Standard: 8 |
