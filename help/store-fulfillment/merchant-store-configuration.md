...
# Konfiguration av butiker (källa)
...
- Ange källan som en [!DNL Store Pickup Location] och ange tillgängliga leveransmöjligheter (Ship to Store, Ship from Store)
...
Villkoren _källa_ och _butiksplats för handlare_ De används omväxlande. Alla poster är lagerkällor, men källorna kan också vara butiksplatser för handlare, beroende på konfigurationsinställningarna.

Hantera konfigurationen av Merchant Stores från administratören: **[!UICONTROL Stores > Inventory > Sources >  Edit Source]**.
...
| **Fält** | **Beskrivning** | **Omfång** | **Obligatoriskt** |
|-----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|--------------|
| **[!UICONTROL Allow In-Store Pickup]**</br>`Extension Attribute: [!DNL store_pickup_enabled]` | Ett av två hämtningsalternativ. [!DNL In-Store Pickup] avser möjligheten att låta en kund ange butiksplatsen för att hämta sin order. </br></br>När det här alternativet är aktiverat kan det visas för kunden vid utcheckningen. </br></br>Det här alternativet åsidosätter även den globala konfigurationen till [!UICONTROL Enable In-store Pickup] som konfigurerats på [!UICONTROL Delivery Method] for [!UICONTROL In-store Pickup] | Global | Nej |
| **Instruktioner för butiksinhämtning**</br>`Extension Attribute: store_pickup_instructions` | Ett anpassningsbart meddelande som levereras till kunden i **Beställ klart för hämtning i Store** e-postmeddelande. | Global | Nej |
| **Tillåt kurbside**</br>`Extension Attribute: curbside_enabled` | Ett av två hämtningsalternativ. Med rabattköp kan kunden parkera sin bil på en viss plats i butiken. I det här scenariot levereras beställningen till kunden av en butikspartner. </br></br>När det här alternativet är aktiverat kan det visas för kunden i kassan. Kunden kan också bli ombedd att beskriva sitt fordon och sin parkeringsplats under incheckningsprocessen. </br></br>Det här alternativet åsidosätter även den globala konfigurationen till **Aktivera Blockside Pickup** som konfigurerats på **Leveranssätt** for **Plocka in i butik** | Global | Nej |
| **[!UICONTROL Curbside Instructions]**</br>`Extension Attribute: curbside_instructions` | Ett anpassningsbart meddelande som levereras till kunden i [!UICONTROL Order Ready For Pickup in Store] e-postmeddelande. | Global | Nej |
| **[!UICONTROL Estimated Pickup Lead Time]**</br>`Extension Attribute: pickup_lead_time` | Antal minuter som krävs innan en order tas emot, plockas och är klar att plockas upp. </br></br>Den här informationen används för att visa beräknade tider för orderhämtning till kunder på webbplatsen.</br></br> Om du anger det här alternativet åsidosätts den globala konfigurationen för **Beräknad plockningstid för lead** konfigurerad för **Leveranssätt** i **Plocka in i butik** konfiguration. | Global | Nej |
| **[!UICONTROL Estimated Pickup Time Label]**</br>`Extension Attribute: pickup_time_label` | Etikett som visar antalet minuter tills en order är klar att plockas upp.</br></br> När du anpassar den här etiketten kan du använda koden %1 för att infoga **Beräknad plockningstid för lead**.</br></br> Om du anger det här alternativet åsidosätts den globala konfigurationen för [!UICONTROL Estimated Pickup Time Label] konfigurerad för [!UICONTROL Delivery Method] i [!UICONTROL In-store Pickup]. | Global | Nej |

### **Öppettider**

| **Fält** | **Beskrivning** | **Omfång** | **Obligatoriskt** |
|------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|--------------|
| **[!UICONTROL Location Timezone]**</br>`Extension Attribute: timezone` | Tidszonen för butiksplatsen för handlare. Ange öppnings- och sluttider för varje dag.</br></br>De här inställningarna används för att optimera beräknade upphämtningstider och för rapportering av sluttjänster. | Global | Ja |
| **[!UICONTROL Opening Hours]**</br>`Internal Attribute: inventory_source_opening_hours_dynamic_rows` | Driftstimmar för butiksplatsen för handlare. </br></br>Den här informationen kan användas för att optimera beräknade upphämtningstider och i rapporter om sluttjänster. | Global | Ja |
...
| **Fält** | **Beskrivning** | **Omfång** | **Obligatoriskt** |
|---------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|--------------|
| **[!UICONTROL Use Parking Spots]**</br>`Extension Attribute: parking_spots_enabled` | Ange om butiksplatsen för handlare har parkeringspunkter för urbside-hämtning. </br></br>När det här alternativet är aktiverat kan du konfigurera tillgängliga parkeringspunkter. | Global | Nej |
| **[!UICONTROL Is Parking Spot a Mandatory Field?]**</br>`Extension Attribute: parking_spot_mandatory` | Ange om det krävs identifiering av parkeringsplats för kunder under shoppingupplevelsen.</br></br>Om det är aktiverat uppmanas kunden att ange sin parkeringsplats vid ankomsten. Om det är inaktiverat kan kunden hoppa över den här inmatningen. | Global | Nej |
| **[!UICONTROL Parking Spots List]**</br> `Internal Attribute: inventory_source_parking_spot_dynamic_rows` | De tillgängliga parkeringsplatserna på den här butiksplatsen för hämtning av reklamskyltar. Använd det angivna gränssnittet för att namnge varje dekorfärg.</br></br> Du behöver inte namnge varje parkeringsplats, bara de punkter som är avsedda för kanten. Du kan till exempel ha rader A-G på parkeringen tillgängliga, men bara de första 8 punkterna på rad A är avsedda för hämtning på sidan. I det här scenariot kan du definiera 8 punkter; ex: A1, A2, A3 och så vidare. | Global | Nej |
...
| **[!UICONTROL Use Car Color]**</br>`Extension Attribute: use_car_color` | Ange om det finns stöd för insamling av fordonsfärg från kunden vid incheckning. </br></br> Tillgängliga val för [!UICONTROL Car Color] har konfigurerats i Admin [systeminställningar för incheckningsupplevelsen](check-in-experience-setup.md). | Global | Nej |
| **[!UICONTROL Is Car Color a Mandatory Field?]**</br>`Extension Attribute: car_color_mandatory` | Ange om identifiering av fordonsfärg krävs för kunder vid incheckning.</br></br>Om det är aktiverat uppmanas kunden att ange färgen på sitt fordon vid ankomsten. Om det är inaktiverat kan kunden hoppa över den här inmatningen. | Global | Nej |
| **[!UICONTROL Use Car Make]** </br>`Extension Attribute: use_car_make` | Ange om det ska finnas stöd för insamling av fordon från kunden vid incheckning.</br></br> Tillgängliga val för [!UICONTROL Car Make] har konfigurerats i Admin [systeminställningar för incheckningsupplevelsen](check-in-experience-setup.md). | Global | Nej |
