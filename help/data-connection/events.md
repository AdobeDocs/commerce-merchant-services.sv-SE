...
Nedan visas de Commerce Behance-händelser som är tillgängliga när du installerar [!DNL Data Connection] tillägg. De data som dessa händelser samlar in skickas till Adobe Experience Platform. Du kan också skapa [anpassade händelser](custom-events.md) för att samla in ytterligare uppgifter som inte lämnats ut.
...
![B2B för Adobe Commerce](../assets/b2b.svg) För B2B-handlare måste du [installera](install.md#install-the-b2b-extension) den `experience-platform-connector-b2b` för att komma åt dessa händelser.
